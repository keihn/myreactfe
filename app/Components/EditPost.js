...
function EditPost() {
  ...
  return (
        <Page title="Edit Post">
            ...
            <Link className="small font-weight-bold" to={`/post/${state.id}`}>&laquo; View post</Link>
            ...
            <form className="mt-3" onSubmit={submitHandler}>
                ...
                <textarea obBlur={ e => dispatch({type: "bodyRules", value: e.target.value})} onChange={(e) => dispatch({type: "bodyChange", value: e.target.value})} value={state.body.value} name="body" id="post-body" className="body-content tall-textarea form-control" type="text"></textarea>
