        ...
        switch (action.type) {
            case "usernameImmediately":
                ...
                if (draft.username.value && !/^([a-zA-Z0-9]+)$/.test(draft.username.value)) {
                    draft.username.hasErrors = true
                    draft.username.message = "Username can only contain letters an numbers"
                }
                return
            ...
            case "passwordAfterDelay":
                if (draft.password.value.length < 12) {
                    draft.password.hasErrors = true
                    draft.password.message = "Password must at least 12 characters."
                }
                return
        ...
        <Page title="Welcome" wide={true}>
            <div className="row align-items-center">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input onChange={e => dispatch({type: "emailEmmediately", value: e.target.value})} id="email-register" name="email" className="form-control" type="text" placeholder="you@example.com" autoComplete="off" />
